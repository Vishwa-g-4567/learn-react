export const content = [
  ...
  },
  {
    ...
    content:
      "Node.js is a cross-platform, open-source server environment that can run on Windows, Linux, Unix, macOS, and more. Node.js is a back-end Javascript runtime environment, runs on th V8 Javascript Engine, and executes JavaScript code outside a web browser.",
  },
  {
